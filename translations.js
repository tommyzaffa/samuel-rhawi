...
window.TRANSLATIONS = {
  it: {
    ...
    map_consent: "La mappa viene caricata da Google solo dopo il tuo consenso.",
    map_load: "Carica mappa",
  ...
  en: {
    ...
    contact_social_title: "Social",
    map_consent: "The map is loaded from Google only after your consent.",
    map_load: "Load map",
  ...
  fr: {
    ...
    map_consent: "La carte est chargée depuis Google uniquement après votre consentement.",
  ...
  de: {
    ...
    contact_social_title: "Social",
    map_consent: "Die Karte wird erst nach deiner Zustimmung von Google geladen.",
